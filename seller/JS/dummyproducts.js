...
export const dummyProducts = [
    ...
    new Product(2, "Chocolate Candy", 15,
        ...
        [1,2,3], 4.2,
        [{ name: "Ali Hassan", comment: "The chocolate has a perfectly balanced sweetness and smooth texture making it enjoyable without feeling overly heavy or sugary." }],
        2, 5),
    ...
    new Product(3, "Green Beans Pack", 30,
        ...
        [1,2,3,5], 4.0,
        [{ name: "Sara Mahmoud", comment: "These beans are always fresh and vibrant in color and they remain crisp and flavorful even after cooking for longer periods." }],
        0, 0),
    ...
    new Product(4, "Best Seller Bread", 20,
        ...
        [1,2], 4.7,
        [{ name: "Omar Nabil", comment: "The texture is incredibly soft with a beautiful crust and it stays fresh longer than most other bread options available." }],
        3, 15),
    ...
    new Product(5, "Whole Wheat Bread", 22,
        ...
        [1,2], 4.3,
        [{ name: "Mona Sami", comment: "Healthy and delicious with a rich whole wheat flavor that makes it perfect for anyone trying to maintain a balanced diet." }],
        2, 8),

    new Product(6, "Vanilla Biscuit", 18,
        ...
        [1,2,3], 4.1,
        [{ name: "Karim Adel", comment: "Crispy texture with a pleasant vanilla aroma that makes it a perfect companion for tea or coffee breaks." }],
        1, 5),

    new Product(7, "Breakfast Cereal", 35,
        ...
        [1,2,3], 4.6,
        [{ name: "Nour Ahmed", comment: "Very nutritious and not overly sweet which makes it ideal for both kids and adults every morning." }],
        4, 12),

    new Product(8, "Strawberry Cake", 80,
        ...
        [1,2,3], 4.8,
        [{ name: "Hassan Tarek", comment: "The strawberries taste fresh and the cream is light and fluffy making every bite extremely enjoyable." }],
        10, 20),

    new Product(9, "Chocolate Cookie", 12,
        ...
        [1,2], 4.4,
        [{ name: "Laila Mostafa", comment: "Rich chocolate flavor with a soft center that makes it comforting and delicious every time." }],
        0, 0),

    new Product(10, "Red Velvet Cupcake", 28,
        ...
        [1,2], 4.9,
        [{ name: "Aya Khaled", comment: "Beautiful presentation and perfectly balanced sweetness making it ideal for birthdays and celebrations." }],
        3, 10),

    new Product(11, "Cheddar Cheese", 45,
        ...
        [1,2,5], 4.6,
        [{ name: "Mahmoud Samir", comment: "Sharp rich flavor with excellent melting quality that works well in many recipes and dishes." }],
        5, 12),

    new Product(12, "Dinner Pasta", 55,
        ...
        [1,2,3,5], 4.2,
        [{ name: "Salma Hany", comment: "Authentic texture and consistent cooking results that make family dinners easy and enjoyable." }],
        6, 10),

    new Product(13, "Honey Bagel", 27,
        ...
        [1,2], 4.5,
        [{ name: "Youssef Ali", comment: "Subtle honey sweetness combined with a soft texture makes this bagel absolutely delicious." }],
        2, 7),

    new Product(14, "Caramel Candy", 16,
        ...
        [1,2,3], 4.3,
        [{ name: "Rana Essam", comment: "Creamy and rich caramel taste that lasts long and feels premium compared to other brands." }],
        1, 5),

    new Product(15, "Black Beans", 32,
        ...
        [1,2,3,5], 4.1,
        [{ name: "Ahmed Farouk", comment: "Consistent quality and excellent flavor after cooking making it perfect for traditional recipes." }],
        0, 0),

    new Product(16, "Butter Croissant", 25,
        ...
        [1,2], 4.7,
        [{ name: "Dina Magdy", comment: "Flaky layers with a strong buttery aroma that truly elevates any breakfast experience." }],
        3, 10),

    new Product(17, "Blueberry Muffin", 30,
        ...
        [1,2], 4.4,
        [{ name: "Tamer Adel", comment: "Generous amount of blueberries with a moist interior that stays soft even after a day." }],
        2, 6),

    new Product(18, "Chocolate Cake", 85,
        ...
        [1,2,3], 4.9,
        [{ name: "Heba Mostafa", comment: "Intense chocolate flavor combined with smooth frosting layers makes this cake outstanding." }],
        8, 18),

    new Product(19, "Vanilla Cookie", 10,
        ...
        [1,2], 4.0,
        [{ name: "Khaled Amin", comment: "Light texture with balanced sweetness making it suitable for both kids and adults." }],
        0, 0),

    new Product(20, "Cream Cheese", 40,
        ...
        [1,2,3], 4.6,
        [{ name: "Mariam Yasser", comment: "Smooth creamy consistency and rich flavor that works perfectly in both savory and sweet dishes." }],
        4, 10),
