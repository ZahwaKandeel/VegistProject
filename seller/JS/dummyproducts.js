...
export const dummyProducts = [
    ...
    [1,2],4.5,
    [{ uid:1, rating:4.5, comment:"This bagel is consistently fresh and soft with an amazing texture that makes breakfast much more enjoyable every single time." }],
    5,10),
    ...
    [1,2,3],4.2,
    [{ uid:1, rating:4.2, comment:"The chocolate has a perfectly balanced sweetness and smooth texture making it enjoyable without feeling overly heavy or sugary." }],
    2,5),
    ...
    [1,2,3,5],4.0,
    [{ uid:1, rating:4.0, comment:"These beans are always fresh and vibrant in color and they remain crisp and flavorful even after cooking for longer periods." }],
    0,0),
    ...
    [1,2],4.7,
    [{ uid:1, rating:4.7, comment:"The texture is incredibly soft with a beautiful crust and it stays fresh longer than most other bread options available." }],
    3,15),
    ...
    [1,2],4.3,
    [{ uid:1, rating:4.3, comment:"Healthy and delicious with a rich whole wheat flavor that makes it perfect for anyone trying to maintain a balanced diet." }],
    2,8),
    ...
    [1,2,3],4.1,
    [{ uid:1, rating:4.1, comment:"Crispy texture with a pleasant vanilla aroma that makes it a perfect companion for tea or coffee breaks." }],
    1,5),
    ...
    [1,2,3],4.6,
    [{ uid:1, rating:4.6, comment:"Very nutritious and not overly sweet which makes it ideal for both kids and adults every morning." }],
    4,12),
    ...
    [1,2,3],4.8,
    [{ uid:1, rating:4.8, comment:"The strawberries taste fresh and the cream is light and fluffy making every bite extremely enjoyable." }],
    10,20),
    ...
    [1,2],4.4,
    [{ uid:1, rating:4.4, comment:"Rich chocolate flavor with a soft center that makes it comforting and delicious every time." }],
    0,0),
    ...
    [1,2],4.9,
    [{ uid:1, rating:4.9, comment:"Beautiful presentation and perfectly balanced sweetness making it ideal for birthdays and celebrations." }],
    3,10),
    ...
    [1,2,5],4.6,
    [{ uid:1, rating:4.6, comment:"Sharp rich flavor with excellent melting quality that works well in many recipes and dishes." }],
    5,12),
    ...
    [1,2,3,5],4.2,
    [{ uid:1, rating:4.2, comment:"Authentic texture and consistent cooking results that make family dinners easy and enjoyable." }],
    6,10),
    ...
    [1,2],4.5,
    [{ uid:1, rating:4.5, comment:"Subtle honey sweetness combined with a soft texture makes this bagel absolutely delicious." }],
    2,7),
    ...
    [1,2,3],4.3,
    [{ uid:1, rating:4.3, comment:"Creamy and rich caramel taste that lasts long and feels premium compared to other brands." }],
    1,5),
    ...
    [1,2,3,5],4.1,
    [{ uid:1, rating:4.1, comment:"Consistent quality and excellent flavor after cooking making it perfect for traditional recipes." }],
    0,0),
    ...
    [1,2],4.7,
    [{ uid:1, rating:4.7, comment:"Flaky layers with a strong buttery aroma that truly elevates any breakfast experience." }],
    3,10),
    ...
    [1,2],4.4,
    [{ uid:1, rating:4.4, comment:"Generous amount of blueberries with a moist interior that stays soft even after a day." }],
    2,6),
    ...
    [1,2,3],4.9,
    [{ uid:1, rating:4.9, comment:"Intense chocolate flavor combined with smooth frosting layers makes this cake outstanding." }],
    8,18),
    ...
    [1,2],4.0,
    [{ uid:1, rating:4.0, comment:"Light texture with balanced sweetness making it suitable for both kids and adults." }],
    0,0),
    ...
    [1,2,3],4.6,
    [{ uid:1, rating:4.6, comment:"Smooth creamy consistency and rich flavor that works perfectly in both savory and sweet dishes." }],
    4,10)
